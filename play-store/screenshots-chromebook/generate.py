#!/usr/bin/env python3
"""Generate 8 Google Play Chromebook screenshots (16:9 laptop). No Jiya branding."""
...
def device(inner, active="explore"):
    ...
    <div class="laptop">
      <div class="chrome">
        ...
        <div class="url">https://travelplanner.app</div>
      </div>
...
<body>
  <div class="frame">
    ...
    <div class="laptop-wrap">{inner}</div>
  </div>
</body>
</html>
"""
...
def main():
    ...
    shots = {
        "01-ai": wrap("AI", "Travel Planner", "Ask. Plan. Go.", "Travel AI Assistant on Chromebook.", "Instant answers for packing, seasons, and trip questions", screen_home()),
