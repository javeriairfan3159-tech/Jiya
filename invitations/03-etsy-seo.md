# Ready Set Go — Etsy SEO (this card)

Paste into Etsy as-is. English is intentional — buyers search in English.

This copy is written for the **READY SET GO / championship shield** card (red shield + LEO + giant 5 + desert highway).

**Category:** Paper & Party Supplies → Party Supplies → Invitations  
**Attributes:** Occasion = Birthday · Who made = You · Primary color = Red · Secondary = Yellow / Black  
**Who is it for:** Boys · Age: Kids (or 5th birthday if listed)

Do **not** put Cars, Lightning McQueen, Mater, Pixar, Disney, Radiator Springs, or Hot Wheels in the title, tags, or description. Those words get clicks, then the listing gets taken down. This copy ranks on the same buyer intent with safer keywords.
...
• For personal party use
• Artwork is original racing / race car — not affiliated with any movie studio or toy brand
...
## Listing photos — file names + alt text

Use this order on Etsy (photo 1 = the search thumbnail).

1. `03-leo-ready-set-go` — alt: `Race car birthday invitation Ready Set Go printable 5x7 boy racing invite`
2. Etsy mockup on asphalt — alt: `Printable racing birthday invitation card mockup checkered flag party`
3. Close crop of the shield + name + 5 — alt: `Custom name race car invite championship shield turning 5 invitation`
4. Close crop of the cars + desert road — alt: `Red race car birthday invitation original racing party artwork`
5. Close crop of date / place / time panel — alt: `Digital invitation 5x7 race car party details and RSVP`
6. White or extra version if you list a bundle — alt: `Printable invite 5x7 race car birthday boy`

---

## Words that will get this listing taken down

Never use in title, tags, description, or photo file names:

- Cars (the movie), Lightning McQueen, Mater, Doc Hudson, Sally
- Pixar, Disney, Radiator Springs, Piston Cup, Ka-chow
- Hot Wheels, Matchbox (toy brands)

Use instead: race car, racing party, Ready Set Go, checkered flag, red race car, championship, desert highway.
